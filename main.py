...
REVIEW_LINK = "https://t.me/tinkervpn"
...
def kb_admin_keys():
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="➕ Добавить Standart", callback_data="admin:keyadd:standard"),
         InlineKeyboardButton(text="🗑 Удалить", callback_data="admin:keydelete:standard")],
        [InlineKeyboardButton(text="➕ Добавить Premium", callback_data="admin:keyadd:premium"),
         InlineKeyboardButton(text="🗑 Удалить", callback_data="admin:keydelete:premium")],
        [InlineKeyboardButton(text="➕ Добавить Family", callback_data="admin:keyadd:family"),
         InlineKeyboardButton(text="🗑 Удалить", callback_data="admin:keydelete:family")],
        [InlineKeyboardButton(text="🧹 Очистить Standart", callback_data="admin:keyclear:standard")],
        [InlineKeyboardButton(text="🧹 Очистить Premium", callback_data="admin:keyclear:premium")],
        [InlineKeyboardButton(text="🧹 Очистить Family", callback_data="admin:keyclear:family")],
        [InlineKeyboardButton(text="⬅️ Назад", callback_data="admin:home")],
    ])
